...
const IconGitHub = () => (
  <svg viewBox="0 0 24 24" style={{ width: '60%', height: '60%' }}>
    ...
    <path fill="#ffffff" d="M12 2.247a10 10 0 00-3.162 19.487c.5.088.682-.217.682-.482 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.342-3.369-1.342-.454-1.155-1.11-1.462-1.11-1.462-.908-.62.069-.608.069-.608 1.003.07 1.531 1.031 1.531 1.031.892 1.529 2.341 1.088 2.91.832.091-.647.35-1.088.636-1.338-2.22-.253-4.555-1.11-4.555-4.943 0-1.091.39-1.984 1.03-2.682-.103-.254-.447-1.27.098-2.645 0 0 .84-.269 2.75 1.025A9.578 9.578 0 0112 6.836a9.59 9.59 0 012.504.337c1.909-1.294 2.747-1.025 2.747-1.025.547 1.375.203 2.391.1 2.645.64.698 1.028 1.59 1.028 2.682 0 3.841-2.337 4.687-4.565 4.935.359.309.678.919.678 1.852 0 1.336-.012 2.415-.012 2.743 0 .267.18.578.688.48A10.001 10.001 0 0012 2.247z" />
  </svg>
);
...
const DOCK_ITEMS = [
  ...
  {
    label: 'GitHub',
    href: 'https://github.com/the404society',
    icon: <IconGitHub />,
    glowColor: 'rgba(36,41,46,0.6)',
  },
  {
    label: 'LinkedIn',
